...
💽 <b><i>RAM ( MEMORY ) :</i></b>
┃ {ram_bar} {ram}%
🕹️ <b>U :</b> {ram_u} | <b>F :</b> {ram_f} | <b>T :</b> {ram_t}

🔃 <b><i>SWAP MEMORY :</i></b>
┃ {swap_bar} {swap}%
🕹️ <b>U :</b> {swap_u} | <b>F :</b> {swap_f} | <b>T :</b> {swap_t}
...
☢️ <b>P-Core(s) :</b> {p_core} | <b>V-Core(s) :</b> {v_core}
🌐 <b>Total Core(s) :</b> {total_core}
🕹️ <b>Usable CPU(s) :</b> {cpu_use}
    '''
...
------------------------------------------\n\n"""
    ...
    # ----- LEECH -------
    L_TOTAL_FILES =         '#️⃣ <b>Total Files: </b>{Files}\n'
